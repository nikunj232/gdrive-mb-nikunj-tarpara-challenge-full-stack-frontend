...
import { documentSvg, externalSvg, fiFileSvg, fiGlobeSvg, fiLockWhiteSvg, fiUsersGraySvg, fiUsersSvg, gDriveSvg, linkedinSvg, metomicLogoSvg, twitterSvg } from '../assets/images'
                ...
                <div className='px-8 mx-auto flex justify-between '>
                    ...
                    <div className='flex items-center gap-4 justify-end'>
                        ...
                        <div className='flex items-center gap-2 justify-end'>
                            <a href="#">
                                <img className='w-6 filter-[invert(100%) sepia(0%) saturate(7458%) hue-rotate(125deg) brightness(111%) contrast(94%)]' src={linkedinSvg} alt="linkedin" />
                            </a> 
                            <a href="#">
                                <img className='w-5' src={twitterSvg} alt="twitter" />
                            </a> 
                        </div>
                    </div>
                </div>
                ...
                <div className='bg-riskpage-container py-10 rounded-lg'>
                    <div className="flex justify-between items-center px-10">
                        ...
                        <div className="flex justify-between items-center gap-4">
                            ...
                            <div className="flex justify-end gap-2 rounded-md bg-orange/15 px-3 py-1.5">
                                <img className='w-6' src={gDriveSvg} alt="google drive" />
                                <span>High</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='px-10 grid grid-cols-4 gap-3'>
                        ...
                        <div className='hover:bg-hover-back w-[25% - 1rem] flex flex-col justify-start items-center border border-gray p-6'>
                            ...
                            {
                                !isLoading && reportData?.totalPublicFile
                        ...
                        <div className='hover:bg-hover-back w-[25% - 1rem] flex flex-col justify-start items-center border border-gray p-6'>
                            ...
                            {
                                !isLoading && reportData?.totalUserAccess
                        ...
                        <div className='hover:bg-hover-back w-[25% - 1rem] flex flex-col justify-start items-center border border-gray p-6'>
                            ...
                            {
                                !isLoading
                                ?<h2 className='text-5xl font-light my-5'>0</h2>
                                :<div className='animate-pulse w-3/4 h-24 rounded-lg my-4 mx-auto bg-dark-gray/15'></div>
                            }
                    ...
                    </div>
                    {
                        !isLoading && reportData ? <>
                                        ...
                                        <TableBody>
                                            {reportData && reportData?.publicFile ? reportData?.publicFile.map((row) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell>
                                                        <a href={`mailto:${row.owner.emailAddress}`}  className='group max-w-72 flex justify-between gap-4 items-center'>
                                                            ...
                                                            <div class="mr-2 flex items-center justify-end xl:flex">
                                                                ...
                                                                <div className='w-4 h-4'>
                                                                    <img class="w-full h-full ml-3 group-hover:block" src={externalSvg}/>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </TableCell>
                            ...
                            <div className='px-10'>
                                <div className='text-3xl font-light mb-4'>
                                    3. {reportData?.totalPublicFile} files are shared externally
                                </div>
                                {
                                    false ?
                                            ...
                                            <TableBody>
                                                {reportData && reportData?.publicFile ? reportData?.publicFile.map((row) => (
                                                    ...
                                                    >
                                                        <TableCell className='group' component="th" scope="row">
                                                            <GetFileIcon type={row.type}/>
                                                            <span className='group-hover:underline group-hover:text-primary-700'>
                                                                {row.filename}
                                                            </span>
                                                        </TableCell>
                                                        <TableCell>
                                                            <a href={row.web_view_link}>
                                                                <span className='px-4 py-2 bg-gray rounded-full'>Anyone with link</span>
                                                            </a>
                                                        </TableCell>
                                                        <TableCell>{row.shared_with}</TableCell>
                                                        <TableCell>
                                                            <a href={`mailto:${row.owner.emailAddress}`}  className='group max-w-72 flex justify-between gap-4 items-center'>
                                                                <div className='group-hover:underline flex items-center justify-start gap-2'>
                                                                    <img className='w-8 rounded-full' src={row?.owner?.photoLink} alt="" srcset="" />
                                                                    <span className='text-wrap group-hover:underline group-hover:text-primart-7   00'>{row?.owner?.displayName}</span>
                                                                </div>
                                                                <div class="items-center justify-end xl:flex">
                                                                    <svg class="w-5 h-5 ml-2 text-black group-hover:text-primary-700" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M2.66732 2.6665H13.334C14.0673 2.6665 14.6673 3.2665 14.6673 3.99984V11.9998C14.6673 12.7332 14.0673 13.3332 13.334 13.3332H2.66732C1.93398 13.3332 1.33398 12.7332 1.33398 11.9998V3.99984C1.33398 3.2665 1.93398 2.6665 2.66732 2.6665Z" stroke="currentColor" stroke-opacity="0.75" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                        <path d="M14.6673 4L8.00065 8.66667L1.33398 4" stroke="currentColor" stroke-opacity="0.75" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    </svg>
                                                                    <a href=""></a>
                                                                    <img class="w-4 h-4 ml-3 group-hover:block" src={externalSvg}/>
                                                                </div>
                                                            </a>
                                                        </TableCell>
                                                    </TableRow>
